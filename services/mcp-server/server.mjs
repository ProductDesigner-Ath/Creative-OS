...
const operationByTool={ae_set_bezier_keyframes:['layer.setBezierKeyframes'],ae_create_composition:['composition.create'],ae_get_active_composition:['composition.getActive',{}],ae_get_layers:['composition.getLayers'],ae_get_composition_state:['composition.getState'],ae_create_text_layer:['layer.createText'],ae_get_position:['layer.getPosition'],ae_get_transform:['layer.getTransform'],ae_get_source_info:['layer.getSourceInfo'],ae_get_text_document:['layer.getTextDocument'],ae_get_animation_state:['layer.getAnimationState'],ae_set_position:['layer.setPosition'],ae_add_position_keyframes:['layer.addPositionKeyframes'],ae_add_opacity_keyframes:['layer.addOpacityKeyframes'],ae_add_transform_keyframes:['layer.addTransformKeyframes'],ae_add_anchor_point_keyframes:['layer.addAnchorPointKeyframes'],ae_set_layer_timing:['layer.setTiming'],ae_get_keyframes:['layer.getKeyframes']};

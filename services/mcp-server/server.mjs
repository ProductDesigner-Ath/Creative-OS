...
const operationByTool={ae_get_active_composition:['composition.getActive',{}],ae_get_layers:['composition.getLayers'],ae_get_composition_state:['composition.getState'],ae_create_text_layer:['layer.createText'],ae_get_position:['layer.getPosition'],ae_get_transform:['layer.getTransform'],ae_set_position:['layer.setPosition'],ae_add_position_keyframes:['layer.addPositionKeyframes'],ae_add_opacity_keyframes:['layer.addOpacityKeyframes'],ae_get_keyframes:['layer.getKeyframes']};
